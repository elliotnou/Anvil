...
const FOOTER_LINKS = {
  Platform: ["MCP Forge", "Safety Engine", "CLI Tool", "Web Dashboard"],
    ...
    <footer className="relative border-t border-border/30">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10">
          <div className="col-span-2 md:col-span-1">
            <Link href="/" className="flex items-center gap-2.5 mb-4">
              <NexusLogo size={32} />
              <span className="font-bold text-foreground">Anvil</span>
            </Link>
            <p className="text-sm text-muted-foreground leading-relaxed">
              Forge safe MCP servers from any API. Classify, generate, deploy.
            </p>
          </div>
        ...
        <div className="mt-12 pt-6 border-t border-border/30 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-muted-foreground">
          <span>&copy; 2026 Anvil. All rights reserved.</span>
